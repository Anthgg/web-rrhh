...
export function SignedContractUpload({
  ...
  const contractDownloadQuery = useQuery({
  ...
  const generateContractMutation = useMutation({
    ...
    onSuccess: (response) => {
      ...
      void contractDownloadQuery.refetch();
    },
  });
  ...
  const generatedContractUrl =
    latestContractUrl ||
    withPdfCacheBust(
      contractDownloadQuery.data?.data.pdf_url ||
        contractDownloadQuery.data?.data.download_url ||
        contractDownloadQuery.data?.data.generated_pdf_url ||
        contractPdfUrl,
    );
        ...
        <div className="space-y-4">
          ...
          >
            ...
            {file ? (
              <div className="space-y-2">
                ...
                <span className="font-semibold text-slate-800 text-sm block max-w-xs truncate">
                  {file.name}
                </span>
              ...
              <div className="space-y-2">
                <UploadCloud className="size-12 text-slate-400 mx-auto" />
          ...
          <div className="flex justify-end gap-3">
            <Button
              ...
              className="rounded-xl bg-indigo-600 text-white font-medium hover:bg-indigo-700 disabled:bg-slate-200 disabled:text-slate-400 px-6 py-2 h-11"
            >
              {isUploading ? (
                <>
