...
export function RequestsLayout({
 ...
 <h2 className="section-title text-2xl font-semibold text-foreground md:text-3xl">
 ...
 <h3 className="mt-1 text-lg font-semibold text-foreground">Resumen del modulo</h3>
 </div>
