...
export function MyBirthdayStatus({ worker }: { worker: BirthdayWorker }) {
 ...
 return (
 <article className="relative overflow-hidden rounded-[1.75rem] border border-white/60 bg-card/75 p-5 shadow-[0_18px_45px_rgba(15,23,42,0.10)] backdrop-blur-xl">
 ...
 <span className="inline-flex w-fit items-center gap-2 rounded-full border border-primary/15 bg-primary-soft/70 px-3 py-1 text-xs font-semibold text-primary">
 <Sparkles className="size-3.5" />
 Tu cumpleaños
 </span>
 <div>
 <h3 className="section-title text-2xl font-semibold text-foreground">{worker.fullName}</h3>
 ...
 <div className="flex size-14 items-center justify-center rounded-2xl bg-card/80 text-primary shadow-[0_16px_34px_rgba(15,118,110,0.18)]">
 ...
 <p className="mt-2 section-title text-lg font-semibold capitalize text-foreground">{birthdayDate}</p>
 </div>
