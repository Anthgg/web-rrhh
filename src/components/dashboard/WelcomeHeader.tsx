...
export function WelcomeHeader({
 ...
 <span className="w-fit rounded-full bg-card/12 px-4 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-white/80">
 Panel ADMIN / RRHH
 </span>
 <div>
 ...
 <div className="rounded-3xl border border-white/15 bg-card/10 p-4">
