...
export function NotificationPanel({
 ...
 <h2 className="section-title text-2xl font-semibold text-foreground">Notificaciones</h2>
 <p className="text-sm text-muted-foreground">Eventos importantes del control de asistencia.</p>
 </div>
 ...
 {alerts.length === 0 ? (
 <p className="text-sm text-muted-foreground">No hay notificaciones en este momento.</p>
 ) : (
 alerts.map((alert) => {
 ...
 <article
 key={alert.type}
 className="grid gap-3 rounded-3xl border border-border bg-card p-4 sm:grid-cols-[auto_1fr_auto] sm:items-center"
 >
