...
export function ReportsTabs() {
 ...
 active
 ? "border-white/20 bg-card/10 text-white shadow-[0_16px_32px_rgba(15,23,42,0.18)]"
 : "border-transparent bg-transparent text-slate-300 hover:border-white/10 hover:bg-card/5 hover:text-white",
 )}
 >
