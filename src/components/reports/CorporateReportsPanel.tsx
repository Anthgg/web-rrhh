...
export function CorporateReportsPanel({
  ...
  const workers = useMemo<WorkerRecord[]>(() => workersQuery.data?.items ?? [], [workersQuery.data]);
  const payrollPeriods = useMemo<PayrollPeriod[]>(() => payrollPeriodsQuery.data ?? [], [payrollPeriodsQuery.data]);
  ...
  if (workersQuery.isLoading && !workersQuery.data) {
    return (
      <ReportsLayout
        title="Reportes Corporativos"
        description="Genera documentos oficiales en PDF con la identidad corporativa de FABRYOR."
    ...
    >
      <div className="grid gap-6">
        <div className="flex items-center gap-4 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          <div className="relative size-16 shrink-0 overflow-hidden rounded-2xl border border-slate-200 bg-white dark:border-slate-700 dark:bg-slate-950">
            <Image
              src="/logo.png"
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          {/* 1. Solicitudes */}
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900 flex flex-col justify-between hover:shadow-md transition-shadow">
            <div className="grid gap-4 mb-5">
              <div className="flex items-start gap-4">
                ...
                <div className="grid gap-1">
                  ...
                  <p className="text-sm leading-5 text-slate-500">Exporta solicitudes laborales filtradas por rango de fechas, estado y trabajador.</p>
                </div>
              </div>
            ...
            <div className="grid gap-4 mb-5">
              <div className="flex items-start gap-4">
                ...
                <div className="grid gap-1">
                  ...
                  <p className="text-sm leading-5 text-slate-500">Descarga el consolidado oficial de asistencia en PDF por colaborador o periodo.</p>
                </div>
              </div>
            ...
            <div className="grid gap-4 mb-5">
              <div className="flex items-start gap-4">
                ...
                <div className="grid gap-1">
                  ...
                  <p className="text-sm leading-5 text-slate-500">Genera el reporte PDF de trabajadores activos o inactivos con filtro departamental.</p>
                </div>
              </div>
            ...
            <div className="grid gap-4 mb-5">
              <div className="flex items-start gap-4">
                ...
                <div className="grid gap-1">
                  ...
                  <p className="text-sm leading-5 text-slate-500">Descarga el documento PDF de planilla por periodo y estado de aprobación.</p>
                </div>
              </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <FieldFrame
                  ...
                  hint={payrollPeriodsQuery.isLoading ? "Cargando periodos..." : undefined}
                >
                  <Select
            ...
            <div className="grid gap-4 mb-5">
              <div className="flex items-start gap-4">
                ...
                <div className="grid gap-1">
                  ...
                  <p className="text-sm leading-5 text-slate-500">Consolidado general de horas, incidencias y eventos operacionales del mes.</p>
                </div>
              </div>
            ...
            <div className="grid gap-4 mb-5">
              <div className="flex items-start gap-4">
                ...
                <div className="grid gap-1">
                  ...
                  <p className="text-sm leading-5 text-slate-500">Historial y saldos de vacaciones por colaborador, año fiscal o estado.</p>
                </div>
              </div>
            ...
            <div className="grid gap-4 mb-5">
              <div className="flex items-start gap-4">
                ...
                <div className="grid gap-1">
                  ...
                  <p className="text-sm leading-5 text-slate-500">Expediente corporativo y control de vigencia documental de los colaboradores.</p>
                </div>
              </div>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900 mt-2">
          ...
          <div className="flex items-start gap-3 rounded-xl bg-amber-50/50 p-4 mb-6 dark:bg-amber-950/25 border border-amber-100 dark:border-amber-900/40">
            ...
            <div className="grid gap-0.5">
              <span className="text-xs font-semibold text-slate-800 dark:text-slate-300">Compilación y Firmas del Backend (RR.HH.)</span>
              <span className="text-xs text-slate-600 dark:text-slate-400 leading-4">
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50 dark:bg-slate-950/80 border-b border-slate-200 dark:border-slate-800">
                  <th className="p-3 text-xs font-bold uppercase tracking-wider text-slate-500">Colaborador</th>
                  <th className="p-3 text-xs font-bold uppercase tracking-wider text-slate-500">Ingreso</th>
                  <th className="p-3 text-xs font-bold uppercase tracking-wider text-slate-500">Estatus</th>
                  <th className="p-3 text-xs font-bold uppercase tracking-wider text-slate-500 text-right">Acciones</th>
                </tr>
              </thead>
                  ...
                  <tr key={row.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-950/20">
                    <td className="p-3">
                      <Input
                        ...
                        className="h-8 text-xs rounded-lg bg-transparent border-slate-200 w-full focus:bg-white dark:bg-transparent"
                      />
                    </td>
                    <td className="p-3">
                      <Input
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 h-10 text-xs font-semibold text-slate-600 border border-slate-200 rounded-xl hover:bg-slate-50 dark:text-slate-300 dark:border-slate-700 dark:hover:bg-slate-800 transition-colors cursor-pointer w-full sm:w-auto"
            >
