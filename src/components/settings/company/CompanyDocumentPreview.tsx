...
export function CompanyDocumentPreview({
 ...
 <div className="inline-flex w-fit items-center gap-2 rounded-full bg-muted px-3 py-1 text-xs font-semibold uppercase tracking-[0.14em] text-muted-foreground">
 <FileText className="size-3.5" />
 Vista previa
 </div>
 <h2 className="section-title text-2xl font-semibold text-foreground">Documento corporativo</h2>
 ...
 <div className="overflow-hidden rounded-[2rem] border border-border bg-muted p-3 shadow-[0_20px_40px_rgba(15,23,42,0.06)]">
 <div className="mx-auto min-h-[760px] max-w-[620px] rounded-[1.5rem] border border-border bg-card shadow-[0_24px_48px_rgba(15,23,42,0.08)]">
 <div
 ...
 <div className="flex h-[86px] w-[110px] items-center justify-center rounded-[1.25rem] border border-white/20 bg-card/12 text-sm font-semibold text-white/80">
 {logoUrl ? (
 ...
 <div className="grid gap-3 rounded-[1.5rem] border border-border bg-muted px-5 py-4">
 ...
 <div className="flex h-[128px] items-center justify-center rounded-[1.5rem] border border-dashed border-slate-300 bg-muted text-sm text-foreground-soft">
 {signatureUrl ? (
 <Image unoptimized width={400} height={400}
 src={signatureUrl}
 alt="Firma digital"
