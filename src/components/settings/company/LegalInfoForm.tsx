...
export function LegalInfoForm({
 ...
 <span className="inline-flex w-fit items-center gap-2 rounded-full bg-primary/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.14em] text-primary">
 <Building2 className="size-3.5" />
 Informacion legal
 </span>
 <div className="grid gap-1">
 <h2 className="section-title text-xl font-semibold text-foreground">Datos oficiales de la empresa</h2>
 ...
 <div className="flex items-start gap-3 rounded-lg border border-border bg-muted px-4 py-3 text-sm text-foreground-soft">
