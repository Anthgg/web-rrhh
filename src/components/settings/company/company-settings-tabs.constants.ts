...
import { Building2, Eye, FileBadge2, LayoutDashboard, Palette, Sliders } from "lucide-react";

export type CompanySettingsSection = "summary" | "legal" | "brand" | "files" | "rules" | "preview";
...
export const companySettingsTabs: CompanySettingsTabItem[] = [
 ...
 { id: "rules", label: "Reglas operativas", icon: Sliders },
