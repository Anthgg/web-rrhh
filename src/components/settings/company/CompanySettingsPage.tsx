...
function buildSummaryCards(completion: CompanyCompletion): SummaryCardConfig[] {
 return [
 {
 icon: Building2,
 title: "Legal",
...
export function CompanySettingsPage() {
 ...
 {isDirty ? <CompanyDirtyBanner /> : null}

 {error ? <CompanySettingsErrorBanner error={error} /> : null}
 ...
 <CompanySettingsSummary completion={completion} summaryCards={summaryCards} />
 ) : null}
