    ...
    <Card className="grid gap-6 p-6">
      <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div className="grid gap-2">
          <div className="inline-flex w-fit items-center gap-2 rounded-full bg-brand/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.14em] text-brand">
            <Building2 className="size-3.5" />
            Informacion legal
          </div>
          <div className="grid gap-1">
            <h2 className="section-title text-2xl font-semibold text-ink">Base legal de la empresa</h2>
      ...
      {!isDirty ? (
        <div className="rounded-[1.5rem] border border-dashed border-slate-200 bg-slate-50/80 px-4 py-3 text-sm text-ink-soft">
