...
export function CompanySettingsHeader({
  ...
  return (
    <section className="sticky top-0 z-20 -mx-4 border-b border-slate-200 bg-slate-50/95 p-4 backdrop-blur sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_auto] xl:items-center">
        <div className="grid gap-3">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-3 py-1 text-xs font-medium text-ink-soft">
