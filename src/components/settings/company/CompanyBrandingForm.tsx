    ...
    <Card className="grid gap-6 p-6">
      <div className="grid gap-2">
        ...
        <div className="grid gap-1">
          <h2 className="section-title text-2xl font-semibold text-ink">Paleta institucional</h2>
      ...
      <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_minmax(320px,0.9fr)]">
          ...
          >
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
              <input
                ...
                className="h-12 w-full cursor-pointer rounded-2xl border border-border bg-white p-1 sm:w-16"
              />
              <Input
        ...
        <div className="grid gap-4 rounded-[1.75rem] border border-slate-200 bg-[linear-gradient(135deg,rgba(248,250,252,0.92),rgba(255,255,255,0.98))] p-5 shadow-[0_18px_36px_rgba(15,23,42,0.06)]">
          <div
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="rounded-[1.5rem] border border-slate-200 bg-white p-4">
              ...
              <p className="text-xs font-semibold uppercase tracking-[0.14em] text-ink-soft">Primario</p>
              <p className="mt-1 font-mono text-sm font-semibold text-ink">{primaryColor}</p>
            </div>
            <div className="rounded-[1.5rem] border border-slate-200 bg-white p-4">
              <div className="mb-3 h-10 rounded-2xl" style={{ backgroundColor: secondaryColor }} />
              <p className="text-xs font-semibold uppercase tracking-[0.14em] text-ink-soft">Secundario</p>
              <p className="mt-1 font-mono text-sm font-semibold text-ink">{secondaryColor}</p>
            </div>
          </div>

          <div className="rounded-[1.5rem] border border-slate-200 bg-white p-4">
            <p className="text-xs font-semibold uppercase tracking-[0.14em] text-ink-soft">Tipografia</p>
