...
export function ProtectedShell({ children }: { children: React.ReactNode }) {
 ...
 <aside
 className={cn(
 "fixed inset-y-0 left-0 z-50 flex w-[272px] flex-col border-r border-border bg-sidebar text-sidebar-foreground transition-transform duration-300 ease-in-out lg:static lg:translate-x-0",
 ...
 <button type="button"
 className="mt-2 flex w-full items-center gap-2.5 rounded-xl px-3 py-2.5 text-[13px] font-medium text-muted-foreground transition-colors duration-200 hover:bg-destructive/10 hover:text-destructive"
 onClick={() => void logout()}
 >
 ...
 <div>
 <h1 className="section-title text-base font-bold text-foreground sm:text-lg">
