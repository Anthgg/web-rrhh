...
export function TemporaryPasswordReveal({
 ...
 <span className="text-xs font-semibold uppercase tracking-wide text-foreground-soft">{label}</span>
 <div className="flex items-center gap-2 rounded-2xl border border-border bg-card p-2">
 <span className="min-w-0 flex-1 select-all truncate px-2 font-mono text-sm font-semibold tracking-wider text-foreground">
 ...
 <div className="w-full max-w-md rounded-3xl border border-white/70 bg-card p-5 shadow-2xl">
 ...
 <div>
 <h3 className="font-semibold text-foreground">Verifica tu identidad</h3>
 ...
 <button
 type="button"
 className="rounded-xl p-2 text-foreground-soft hover:bg-muted"
