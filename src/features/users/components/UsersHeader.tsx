...
export function UsersHeader({ onExportPDF, onExportExcel, isExportingPdf, isExportingExcel }: UsersHeaderProps) {
 ...
 <p className="text-xs font-bold uppercase tracking-wider text-primary">ACCESOS</p>
 <h1 className="text-2xl font-bold tracking-tight text-foreground">Usuarios</h1>
 <p className="text-sm text-foreground-soft">Gestión de usuarios del sistema, roles, accesos y vinculación laboral.</p>
 </div>
