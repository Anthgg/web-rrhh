...
export function LoginForm() {
  ...
  return (
    <main className="flex min-h-screen w-full">
      ...
      <div className="relative hidden w-[52%] overflow-hidden bg-gradient-to-br from-teal-700 via-teal-800 to-emerald-900 lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="relative z-10 flex flex-1 flex-col justify-between p-10 xl:p-14">
          ...
          <div className="flex items-center gap-3">
            <div className="relative size-10 overflow-hidden rounded-xl bg-white/10 p-1.5 backdrop-blur-sm">
              <Image
                src="/logo.png"
                alt="FABRYOR"
                fill
      ...
      <div className="relative flex w-full flex-1 items-center justify-center bg-slate-50 px-6 py-12 lg:w-[48%]">
        ...
        <div className="relative z-10 w-full max-w-md">
          ...
          <div className="mb-10 flex items-center gap-3 lg:hidden">
            <div className="relative size-10 overflow-hidden rounded-xl bg-brand/10 p-1.5">
              <Image
                src="/logo.png"
                alt="FABRYOR"
                fill
            ...
            <span className="text-lg font-bold tracking-tight text-ink">FABRYOR</span>
          </div>

          {/* Form Card */}
          <div className="rounded-3xl border border-white/60 bg-white/80 p-8 shadow-2xl shadow-brand/5 ring-1 ring-black/5 backdrop-blur-xl sm:p-10">
            {/* Header */}
            <div className="mb-8 space-y-2">
              <h2 className="section-title text-2xl font-bold tracking-tight text-ink sm:text-3xl">
                Bienvenido de nuevo
              </h2>
            ...
            <form className="space-y-5" onSubmit={onSubmit}>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    autoComplete="email"
                    className={cn(
                      "h-12 w-full rounded-xl border bg-white pl-11 pr-4 text-sm text-ink outline-none transition-all duration-200 placeholder:text-slate-400",
                      errors.email
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={cn(
                      "h-12 w-full rounded-xl border bg-white pl-11 pr-12 text-sm text-ink outline-none transition-all duration-200 placeholder:text-slate-400",
                      errors.password
                        ? "border-rose-300 focus:border-rose-400 focus:ring-2 focus:ring-rose-100"
                        : "border-slate-200 focus:border-brand focus:ring-2 focus:ring-brand/20",
                    )}
                  ...
                  <button
                    type="button"
                    tabIndex={-1}
                    className="absolute right-3 top-1/2 -translate-y-1/2 rounded-lg p-1 text-slate-400 transition-colors hover:text-ink-soft"
              ...
              <button
                ...
                disabled={isLoading}
                className={cn(
                  "group relative mt-2 flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-brand text-sm font-semibold text-white shadow-lg shadow-brand/20 transition-all duration-200",
                  isLoading
                    ? "cursor-not-allowed opacity-70"
                    : "hover:-translate-y-0.5 hover:bg-brand-strong hover:shadow-xl hover:shadow-brand/25 active:translate-y-0",
                )}
              >
                {isLoading ? (
                  <>
          ...
          {/* Bottom copyright */}
          <p suppressHydrationWarning className="mt-6 text-center text-xs text-slate-400">
