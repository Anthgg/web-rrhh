...
export function WorkTeamFilters({ 
  ...
  return (
    <div className="flex flex-col xl:flex-row items-center gap-3 mb-6 bg-white p-3 rounded-2xl border border-slate-200 shadow-sm">
      <div className="relative flex-1 w-full">
        ...
        <Input
          ...
          className="pl-9 bg-slate-50 border-transparent focus-visible:bg-white w-full rounded-xl"
        />
        {searchQuery && (
          <button 
      ...
      <div className="flex flex-wrap sm:flex-nowrap items-center gap-3 w-full xl:w-auto">
        <div className="w-full sm:w-[180px] shrink-0">
          <Select 
            ...
            className="rounded-xl bg-slate-50 border-transparent hover:border-slate-300"
          >
        ...
        <div className="relative w-full sm:w-auto">
          <Button 
            ...
            className={`w-full sm:w-auto gap-2 rounded-xl ${hasAdvancedFilters ? 'bg-indigo-50 text-indigo-700 border-indigo-200 hover:bg-indigo-100 hover:border-indigo-300' : 'border-slate-200 text-slate-700 bg-white hover:bg-slate-50'}`}
          >
            <SlidersHorizontal className={`size-4 ${hasAdvancedFilters ? 'text-indigo-600' : 'text-slate-500'}`} />
