...
export function WorkersByLocationView({
  ...
  if (locations.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center p-16 bg-white rounded-2xl border border-slate-200 shadow-sm text-center">
        ...
        <h3 className="text-xl font-bold text-slate-900 mb-2">Aún no hay obras registradas</h3>
  ...
  if (filteredLocations.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center p-16 bg-white rounded-2xl border border-slate-200 shadow-sm text-center">
        <Building2 className="size-16 mb-4 text-slate-200" />
        <h3 className="text-xl font-bold text-slate-900 mb-2">No se encontraron obras</h3>
        <p className="text-sm text-slate-500 max-w-sm mb-6">
