...
export function ConfirmAssignmentDialog({ isOpen, onClose, onConfirm, isPending, conflictCount }: ConfirmAssignmentDialogProps) {
 ...
 <div className="flex w-full max-w-md flex-col rounded-2xl bg-card shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
 ...
 <h3 className="text-lg font-bold text-foreground mb-2">Advertencia de Asignación</h3>
 ...
 <button onClick={onClose} className="text-muted-foreground hover:text-muted-foreground p-1">
 <X className="size-4" />
 </button>
 </div>
 
 <div className="bg-muted border-t border-border px-6 py-4 flex justify-end gap-3">
