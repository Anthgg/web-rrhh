...
export function AdvancedFiltersPopover(props: AdvancedFiltersPopoverProps) {
 ...
 return <AdvancedFiltersPopoverContent {...props} />;
}

function AdvancedFiltersPopoverContent({ onClose, filters, setFilters }: AdvancedFiltersPopoverProps) {
 ...
 <div 
 ref={popoverRef}
 className="bg-card rounded-2xl shadow-xl border border-border overflow-hidden flex flex-col"
 >
 ...
 onClick={onClose}
 className="text-muted-foreground hover:text-muted-foreground p-1 rounded-md hover:bg-muted"
 >
 <X className="size-4" />
 </button>
 </div>
 ...
 <label htmlFor="advanced-filter-supervisor" className="text-sm font-medium text-foreground">Supervisor</label>
 <Input 
 id="advanced-filter-supervisor"
 ...
 <div className="space-y-1.5">
 <label htmlFor="advanced-filter-work-location" className="text-sm font-medium text-foreground">Obra Principal</label>
 <Input 
 id="advanced-filter-work-location"
 ...
 <div className="flex items-center gap-3 p-4 border-t border-border bg-muted justify-end">
 <Button variant="secondary" onClick={handleClear} className="text-muted-foreground border-border">
 Limpiar
 </Button>
