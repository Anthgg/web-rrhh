                ...
                render={({ field }) => (
                  <FieldFrame label="Departamento (Opcional)" error={errors.department_id?.message}>
                    ...
                    >
                      ...
                      {(Array.isArray(departmentsQuery.data) ? departmentsQuery.data : (departmentsQuery.data as any)?.items || (departmentsQuery.data as any)?.data || []).map((dept: any) => (
              ...
              <Controller
                ...
                render={({ field }) => (
                  <FieldFrame label="Rol Predeterminado (Opcional)" error={errors.role_id?.message}>
                    ...
                    >
                      <option value="">Sin asignar</option>
                      {(Array.isArray(rolesQuery.data) ? rolesQuery.data : (rolesQuery.data as any)?.items || (rolesQuery.data as any)?.data || []).map((role: any) => (
