...
export function DocumentsWorkspace() {
 ...
 <span className="text-xs text-foreground-soft">{item.category}</span>
 </div>
 ),
 },
 {
 ...
 <span className="text-xs text-foreground-soft">{item.project ?? "Sin proyecto"}</span>
 </div>
 ),
 },
 {
